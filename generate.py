...
def parse_args():
    ...
    argp.add_argument('--fractions', help='text file generated by download.py')
    argp.add_argument('--publications', help='.csv table of publications')
...
# Т.к. в csv не указаны типы,
# предполагаем, что все, что выглядит как число,
# им и является
